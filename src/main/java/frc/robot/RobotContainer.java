...
public class RobotContainer {
    ...
    public Command getAutonomousCommand() {
        ...
        return new RamseteCommandWrapper(drivetrain, new Pose2d(0, 0, new Rotation2d(0)), List.of(), new Pose2d(3, 0, new Rotation2d(0))).andThen(() -> drivetrain.tankLRVolts(0, 0));
