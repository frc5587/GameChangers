...
public class RamseteCommandWrapper extends CommandBase {
    ...
    public RamseteCommandWrapper(Drivetrain drivetrain, AutoPaths paths) {
    ...
    public enum AutoPaths {
        ...
        SCurve, ReverseRightSideToPowerPort, ReverseToRendezvous, SCurveFromRendezvous, ReverseToTrench,
        ReverseUnderTrench, Back, Forward, Circle, Loop;
